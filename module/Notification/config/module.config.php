    ...
    'bjyauthorize' => array(
        'guards' => array(
            'BjyAuthorize\Guard\Controller' => array(
                array('controller' => 'Notification\Controller\Notification','action'=> array('index','my','new','read','add','addNotificationNote'),'roles' => array('inner','admin','forwarder','orgAdmin','customer','carrier')),
            ),
