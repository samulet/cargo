    ...
    'bjyauthorize' => array(
        'guards' => array(
            'BjyAuthorize\Guard\Controller' => array(
                array('controller' => 'Ticket\Controller\Ticket','action'=> array('add','createBill'),'roles' => array('accAdmin','forwarder','carrier','customer','admin')),
                array('controller' => 'Ticket\Controller\Ticket','action'=> array('my'),'roles' => array('forwarder','customer','admin')),
                array('controller' => 'Ticket\Controller\Ticket','action'=> array('delete'),'roles' => array('forwarder','customer','admin','accAdmin')),
                array('controller' => 'Ticket\Controller\Ticket','action'=> array('index','search', 'getResults'),'roles' => array('forwarder','carrier','admin')),
                array('controller' => 'Ticket\Controller\Ticket','action'=> array('myAcc'),'roles' => array('forwarder','accAdmin','admin')),
                ...
                array('controller' => 'Ticket\Controller\Cargo', 'action' => array('add', 'edit', 'list', 'delete', 'addCargo'), 'roles' => array('accAdmin','forwarder','customer','admin')),
                array('controller' => 'Ticket\Controller\Cargo','action'=> array('myAcc'),'roles' => array('forwarder','accAdmin','admin')),
            ),
